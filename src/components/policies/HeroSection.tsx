		...
		<section className="py-20 px-4 sm:px-6 lg:px-8">
			<div className="max-w-4xl mx-auto">
				...
				<div className="bg-white rounded-2xl shadow-lg border-2 border-[#F5A855] overflow-hidden">
					<div className="h-[500px] overflow-y-scroll p-6 md:p-8">
						<div className="space-y-8 text-gray-700">
							{/* Introduction */}
							<div className="space-y-4">
								<p className="leading-relaxed">
									The Warmpawz mobile application and related web platform ("Platform") are owned and operated by <strong>WHISTLEFETCH TECHNOLOGIES PRIVATE LIMITED</strong>, a company incorporated under the Companies Act, 2013, having its registered office at IndiQube South Mile, #17 & 17/1, South End Road, Vijayarangam Layout, Basavanagudi, Bangalore – 560 004, Karnataka, India ("WTPL").
								</p>
							...
							<div className="space-y-4">
								...
								<p>We may collect the following personally identifiable information, including but not limited to:</p>
								<ul className="list-disc pl-6 space-y-2">
									...
									<li>such other information as we may request from you from time to time.</li>
								</ul>
								
								<p className="mt-4">We may also collect information pertaining:</p>
								<ul className="list-disc pl-6 space-y-2">
									<li>the links you click on this Platform;</li>
									<li>the number of times you access the Platform's page/portal;</li>
									<li>Your location and real-time tracking only while certain Services are active such as pet walking, grooming, doorstep delivery only when the service provider has marked themselves as "on duty" or "service in progress";</li>
									<li>billing name, billing address and payment method when you engage in a transaction; and</li>
							...
							<div className="space-y-4">
								...
								<ul className="list-disc pl-6 space-y-2">
									...
									<li>details verified through a local level committee or other lawful mechanism prescribed under applicable laws.</li>
								</ul>
								<p>
