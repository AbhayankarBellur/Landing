...
const Navbar = () => {
  ...
  return (
    <>
      {/* Content Mask - Hides scrolled content above navbar */}
      <div className="fixed top-0 left-0 right-0 h-6 bg-white z-30" />
      
      {/* Additional side masks to prevent edge content bleeding */}
      <div className="fixed top-0 left-0 w-6 h-28 bg-white z-30" />
      <div className="fixed top-0 right-0 w-6 h-28 bg-white z-30" />
      
      <nav className="fixed top-4 left-4 right-4 z-40 bg-white rounded-full shadow-lg border border-gray-100">
      ...
      <div className="md:hidden">
        ...
        <div 
          ...
          style={{
            ...
            opacity: isMobileMenuOpen ? 1 : 0,
            pointerEvents: isMobileMenuOpen ? 'auto' : 'none',
            transition: 'transform 280ms cubic-bezier(0.4, 0, 0.2, 1), opacity 180ms ease-out'
          }}
          role="navigation"
